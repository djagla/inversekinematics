...
function orientation(theta1, theta2, theta3, R, DH) {
    ...
    if (Math.sin(theta5) == 0) {
        ...
        var theta4 = -Math.atan2(-R3_6.get([0, 2]) / Math.sin(theta5), R3_6.get([1, 2]) / Math.sin(theta5));
        var theta6 = Math.atan2(R3_6.get([2, 0]) / Math.sin(theta5), -R3_6.get([2, 1]) / Math.sin(theta5));
    }
...
function inverseKinematics(a1, a2, a3, d6, x, y, z, euler_x, euler_y, euler_z) {
    ...
    var R = math.matrix([
        [Math.cos(euler_y) * Math.cos(euler_z), -Math.cos(euler_y) * Math.sin(euler_z), -Math.sin(euler_y)],
        [-Math.sin(euler_x) * Math.sin(euler_y) * Math.cos(euler_z) + Math.cos(euler_y) * Math.sin(euler_z), Math.sin(euler_x) * Math.sin(euler_y) * Math.sin(euler_z) + Math.cos(euler_x) * Math.cos(euler_z), -Math.sin(euler_x) * Math.cos(euler_y)],
        [Math.cos(euler_x) * Math.sin(euler_y) * Math.cos(euler_z) + Math.sin(euler_x) * Math.sin(euler_z), -Math.cos(euler_x) * Math.sin(euler_y) * Math.sin(euler_z) + Math.sin(euler_x) * Math.cos(euler_z), Math.cos(euler_x) * Math.cos(euler_y)]
    ]);
    ...
    var DH = math.matrix([
        ...
        [theta2 - Math.PI / 2, 0, a2, 0],
        [theta3, -Math.PI / 2, 0, 0]
